        ...
        <div className="Form">
            ...
            <div className="formcontainer"></div>
                ...
                <div className="footer">
                    {page < formTitles.length? <button disabled={page===0} onClick={ back}>Prev</button> : < ></>}
                   { page !== formTitles.length  && <button onClick={ next}>{page < formTitles.length - 1  ? "Next" : "Submit" }</button> }
                </div>
